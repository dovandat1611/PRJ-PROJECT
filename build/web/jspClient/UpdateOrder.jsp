                    ...
                    <form class="login-form validate-form" action="OrderController" method="post" >
                        ...
                        <table>
                            ...
                            <div class="wrap-input">
                                ...
                                <input class="input" type="double" name="total_price" id="total_price" value="<%=order.getTotal_price()%>">
                            </div>

                            <div class="wrap-input">
                                <label for="date">Date: </label>
                                <input class="input" type="text" name="date" id="date" value="<%=order.getDate()%>">
                            </div>
                            ...
                            <c:if test="${status.equalsIgnoreCase('Wait')}">
                                <div class="wrap-input">
                                    ...
                                    <Select class="input" name="statuss" id="statuss">                        
                                        <option ${status.equalsIgnoreCase('Wait')?"selected":""} value="Wait">Wait</option>
                            ...
                            <c:if test="${status.equalsIgnoreCase('Process')}">
                                <div class="wrap-input">
                                    ...
                                    <Select class="input" name="statuss" id="statuss">  
                                        ...
                                        <option ${status.equalsIgnoreCase('Process')?"selected":""} value="Process">Process</option> 
                                        <option value="Done">Done</option>
                                    </Select>
                                </div>
                            </c:if>

                            <c:if test="${status.equalsIgnoreCase('Done')}">
                                <div class="wrap-input">
                                    <label for="statuss">Status: </label>
